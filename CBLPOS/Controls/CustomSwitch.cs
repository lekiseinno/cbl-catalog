...
namespace CBLPOS.Controls
{
    public class CustomSwitch : Switch
    {
        ...
        public static readonly BindableProperty SwitchOffTextProperty =
          BindableProperty.Create(nameof(SwitchOffText),
              typeof(String), typeof(CustomSwitch),
               string.Empty);
        ...
        public static readonly BindableProperty SwitchOnTextProperty =
          BindableProperty.Create(nameof(SwitchOnText),
              typeof(String), typeof(CustomSwitch),
                string.Empty);
